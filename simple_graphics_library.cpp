...
namespace SimpleGraphicsLibrary {
  ...
  unsigned int VAOrectangle(float topLeftX, float topLeftY, float width, float height) {
    float vertices[] = {
  ...
  void Window::drawRectangle(float topLeftX, float topLeftY, float width, float height, Color_t color) {
